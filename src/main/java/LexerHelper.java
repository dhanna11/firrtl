...
public abstract class LexerHelper {
  ...
  protected LexerHelper(int nlToken, int indentToken, int dedentToken) {
  ...
  public interface Builder3 {
    LexerHelper pullToken(TokenPuller puller);
  }
  ...
  private static class BuilderImpl implements Builder0, Builder1, Builder2, Builder3 {
    ...
    @Override
    public LexerHelper pullToken(TokenPuller puller) {
      final TokenPuller p = puller;
      return new LexerHelper(nl, indent, dedent) {
        @Override
